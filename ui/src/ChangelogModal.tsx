...
export const RELEASES: Release[] = [
  {
    ...
    date: "4 Aug 2026",
    changed: [
      "Internal: the app now quietly saves each chat exchange server-side — no visible change yet, just more groundwork for cross-device history.",
    ],
  },
  {
    version: "0.83.0",
  ...
  },
  {
    ...
    date: "31 Jul 2026",
    changed: [
      "Internal: the app now quietly remembers your browser between visits, laying more groundwork for saved chat history — nothing changes for you yet.",
    ],
  },
  {
    version: "0.81.0",
    date: "30 Jul 2026",
    changed: [
      "Internal: fixed a database permissions gap that would have exposed new account data to the wrong internal role — caught before it ever reached production.",
    ],
  },
  {
    version: "0.80.0",
