...
_SHARED_RULES = (
    ...
    "then deliver the complete answer in a single response. For transfer or squad questions, "
    "call get_my_fpl_team, get_chip_status, get_fixtures, and any database queries you need "
    "before writing a single word of your answer — never stop halfway through to ask for "
    "more information or signal that you are about to do more work.\n\n"
