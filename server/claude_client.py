...
_SHARED_RULES = (
    ...
    "almost never be transferred out.\n"
    "5. For EVERY player you are considering transferring IN, call get_fixtures or "
    "get_team_all_fixtures for their team. NEVER state a fixture (opponent, home/away) "
    "without having retrieved it from a tool — never construct fixtures from memory.\n"
    ...
    "DATA ACCURACY RULES:\n"
    "- NEVER interpret '0 FPL points' as 'did not play (DNP)'. A player can score 0 points "
    "while playing 90 minutes (e.g. a defender in a 0-0, or a midfielder with no attacking "
    "returns). Only state a player did not play if the squad data explicitly shows minutes=0 "
    "or they are flagged as not selected.\n"
