...
_SHARED_RULES = (
    ...
    "When recommending transfer targets, do not suggest a DEF or GKP from the same club as "
    "a defender or goalkeeper already in the user's squad, unless that club is in the top 6 "
    "or has a double gameweek. Doubling up on defenders from the same mid- or lower-table "
    "side concentrates clean sheet and fixture risk — flag this explicitly if the user "
